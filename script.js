...
function setPedidoStatus(id, status) {
    ...
    if (document.getElementById("loaderOrdersScreen") && document.getElementById("loaderOrdersScreen").style.display === "flex") {
...
function hideAllScreens() {
    const screenIds = [
        ...
        "filterScreen", "mainApp", "materialSelectionPage", "loaderOrdersScreen",
        ...
        pedido.produtos[setor].forEach(produto => {
            ...
            etiquetaHTML += `
                <div class="etiqueta">
                    ...
                    <div class="logo">
                        <!-- O código da imagem em base64 foi omitido conforme solicitado -->
                    </div>
